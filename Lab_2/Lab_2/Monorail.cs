...
namespace WindowsFormsMonorail
{
    public class Monorail : Locomotive
    {
        ...
        public Monorail(int maxSpeed, float weight, Color bodycolor, Color sidestrip, bool window, bool doors) : base(maxSpeed, weight, bodycolor, sidestrip, window, doors)
        {
            MaxSpeed = maxSpeed;
            Weight = weight;
            Window = window;
